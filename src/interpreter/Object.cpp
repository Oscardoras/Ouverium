    ...
    Object::Object(Object const& object) {
        for (auto & f : object.functions) {
            ...
            case Function::Custom:
                functions.push_front(std::make_unique<CustomFunction>((CustomFunction&) *f));
                break;
            case Function::System:
                functions.push_front(std::make_unique<SystemFunction>((SystemFunction&) *f));
                break;
            }
        }
