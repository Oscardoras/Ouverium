...
namespace Interpreter {
    ...
    namespace String {
        ...
        Reference string(FunctionContext & context) {
            ...
            auto f = std::make_unique<SystemFunction>(index_of_p(), index_of);
            f->extern_symbols["this"] = array;
            array_object->get_property("index_of", context)->functions.push_front(std::move(f));

            f = std::make_unique<SystemFunction>(substring_p(), substring);
            f->extern_symbols["this"] = array;
            array_object->get_property("substring", context)->functions.push_front(std::move(f));
        ...
        void init(Context & context) {
            context.get_symbol("Char").to_object(context)->functions.push_front(std::make_unique<SystemFunction>(string_p(), char_constructor));
            context.get_symbol("Char").to_object(context)->get_property("is_digit", context)->functions.push_front(std::make_unique<SystemFunction>(char_is_p(), char_is_digit));
            context.get_symbol("Char").to_object(context)->get_property("is_alpha", context)->functions.push_front(std::make_unique<SystemFunction>(char_is_p(), char_is_alpha));
            context.get_symbol("Char").to_object(context)->get_property("is_alphanum", context)->functions.push_front(std::make_unique<SystemFunction>(char_is_p(), char_is_alphanum));

            context.get_symbol("String").to_object(context)->functions.push_front(std::make_unique<SystemFunction>(string_p(), string));

            context.get_symbol("+").to_object(context)->functions.push_front(std::make_unique<SystemFunction>(concat_p(), concat));
            context.get_symbol("~").to_object(context)->functions.push_front(std::make_unique<SystemFunction>(includes_p(), includes));
            context.get_symbol(":+").to_object(context)->functions.push_front(std::make_unique<SystemFunction>(concat_p(), assign_concat));
        }
