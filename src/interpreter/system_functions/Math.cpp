...
namespace Interpreter::SystemFunctions {
    ...
    namespace Math {
        ...
        void init(GlobalContext& context) {
            insert(context, "!")->functions.push_front(SystemFunction{ a, logical_not });
            insert(context, "&")->functions.push_front(SystemFunction{ a_b, logical_and });
            insert(context, "|")->functions.push_front(SystemFunction{ a_b, logical_or });
            insert(context, "+")->functions.push_front(SystemFunction{ ab, addition });
